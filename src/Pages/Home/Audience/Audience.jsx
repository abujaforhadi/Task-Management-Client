...
const Audience = () => {
    return (
        <div className="">
            <div className="text-center ml-10 mb-4 items-center">
                <h1 className="font-semibold text-2xl">Our Audience</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:px-10 px-6">
                ...
                <div className="border-2 border-[#2a346f] bg-[#2a346f] h-[200px] flex flex-col rounded-[15px] overflow-hidden transition-all hover:bg-[#5ae253] hover:border-[#5ae253]  hover:scale-105  hover:shadow-2xl group">
                    ...
                    <div className="h-[200px] flex-[2] flex flex-col justify-between bg-white rounded-[12px] p-[15px] transition-all">
                        <div className="h-[100px] text-xl text-center flex items-center">
                            <p>Developer success with efficient coding tools and collaboration.</p>
                        </div>
                ...
                <div className="border-2 border-[#2a346f] bg-[#2a346f] h-[200px] flex flex-col rounded-[15px] overflow-hidden transition-all hover:bg-[#5ae253] hover:border-[#5ae253]  hover:scale-105  hover:shadow-2xl group">
                    ...
                    <div className="h-[200px] flex-[2] flex flex-col justify-between bg-white rounded-[12px] p-[15px] transition-all">
                        <div className="h-[100px] text-xl text-center flex items-center">
                            <p>Simplify banking for success with secure, user-friendly solutions.</p>
                        </div>
                ...
                <div className="border-2 border-[#2a346f] bg-[#2a346f] h-[200px] flex flex-col rounded-[15px] overflow-hidden transition-all hover:bg-[#5ae253] hover:border-[#5ae253]  hover:scale-105  hover:shadow-2xl group">
                    ...
                    <div className="h-[200px] flex-[2] flex flex-col justify-between bg-white rounded-[12px] p-[15px] transition-all">
                        <div className="h-[100px] text-xl text-center flex items-center">
                            <p>Illuminate creativity with our designer tools – crafting visual excellence seamlessly.</p>
                        </div>
                ...
                <div className="border-2 border-[#2a346f] bg-[#2a346f] h-[200px] flex flex-col rounded-[15px] overflow-hidden transition-all hover:bg-[#5ae253] hover:border-[#5ae253]  hover:scale-105  hover:shadow-2xl group">
                    ...
                    <div className="h-[200px] flex-[2] flex flex-col justify-between bg-white rounded-[12px] p-[15px] transition-all">
                        <div className="h-[100px] text-xl text-center flex items-center">
                            <p>Drive corporate success with streamlined solutions for efficiency and excellence.</p>
                        </div>
                ...
                <div className="border-2 border-[#2a346f] bg-[#2a346f] h-[200px] flex flex-col rounded-[15px] overflow-hidden transition-all hover:bg-[#5ae253] hover:border-[#5ae253]  hover:scale-105  hover:shadow-2xl group">
                    ...
                    <div className="h-[200px] flex-[2] flex flex-col justify-between bg-white rounded-[12px] p-[15px] transition-all">
                        <div className="h-[100px] text-xl text-center flex items-center">
                            <p>Simplify freelancing, boost productivity effortlessly with our tools.</p>
                        </div>
                ...
                <div className="border-2 border-[#2a346f] bg-[#2a346f] h-[200px] flex flex-col rounded-[15px] overflow-hidden transition-all hover:bg-[#5ae253] hover:border-[#5ae253]  hover:scale-105  hover:shadow-2xl group">
                    ...
                    <div className="h-[200px] flex-[2] flex flex-col justify-between bg-white rounded-[12px] p-[15px] transition-all">
                        <div className="h-[100px] text-xl text-center flex items-center">
                            <p>Student success made simple with our user-friendly learning resources.</p>
                        </div>
